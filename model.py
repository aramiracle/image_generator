...
class PCAGenerator(nn.Module):
    ...
    def forward(self, x):
        x0 = x.unsqueeze(2).unsqueeze(3)  # Input: 256x1x1
        x1 = self.deconv1(x0)  # Output: 128x2x2
        x2 = self.deconv2(x1)  # Output: 64x4x4
        x3 = self.deconv3(x2)  # Output: 32x8x8
        x4 = self.deconv4(x3)  # Output: 16x16x16
